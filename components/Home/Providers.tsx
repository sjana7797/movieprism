      ...
      <div className="flex space-x-5 overflow-x-scroll p-5 scrollbar-hide">
        {providers.map((provider) => (
          <Link key={provider.key} href={provider.link} passHref>
            <div className="group relative h-auto min-h-[180px] min-w-[320px] cursor-pointer overflow-hidden rounded-md border-2 border-transparent transition-colors duration-300 hover:border-slate-300">
              <Image
                src={provider.img}
                alt={provider.title}
